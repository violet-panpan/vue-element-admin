  ...
  <div class="tab-container">
		<el-row :gutter="10">
		  <el-col :span="2"  style="margin-left: 43px;">
		  	...
		  	<el-select v-model="pagination.status" placeholder="推送状态">
		    <el-option
		   ...
		   <el-col :span="2">
		  	<div class="grid-content">
		  	<el-select v-model="pagination.occupation" placeholder="职业类型">
		    <el-option
		  ...
		  <el-col :span="2">
		  	<div class="grid-content">
		  		 <el-input v-model="pagination.realName" placeholder="姓名"></el-input>
		  	</div>
		  </el-col>
		  <el-col :span="2">
		  	<div class="grid-content">
		  		 <el-input v-model="pagination.account" placeholder="手机号码"></el-input>
		    </div>
		  </el-col>
		   <el-col :span="2">
		  	<div class="grid-content">
		  		 <el-input v-model="pagination.city" placeholder="省份|城市"></el-input>
		    </div>
		  </el-col>
		   <el-col :span='3.2'>
		  	<div class="grid-content">
