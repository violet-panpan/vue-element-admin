...
formatTime(row){
  ...
  upformatTime(row){
   ...
   del(row){
    ...
    update(row){
      	this.$router.push({path:'/operate/addQuestion',query:{id:row.id,typeId:this.pagination.typeId}});
    },
    add(){
    	this.$router.push({path:'/operate/addQuestion',query:{typeId:this.pagination.typeId}});
    },
  },
   created() {
